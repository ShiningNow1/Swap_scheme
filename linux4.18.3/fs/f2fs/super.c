...
try_onemore:
	...
	*/
	...
	//COMPLETED:NVM GC的锁
	mutex_init(&nsbi->nvm_gc_curseg_lock);
	...
	if(nsbi->nvm_flag & NVM_FIRST_MOUNR) {
		...
		nvm_debug(1,"nsb->lfu_blkaddr0:%d", nsb->lfu_blkaddr0);
		nvm_debug(1,"nsb->lfu_blkaddr1:%d", nsb->lfu_blkaddr1);
...
skip_recovery:
	 ...
	 */
	 if (test_opt(sbi, BG_GC) && !f2fs_readonly(sb)) {
	 	...
	 	/*start*/
	 	//TODO:开启nvm GC线程
	 	err = f2fs_start_nvm_gc_thread(sbi);
	 	if (err)
	 		goto free_meta;
	 	/*end*/
	 }
	...
	/*start: 初始化bio统计信息*/
    // 缓存IO
	nsbi->r_re_data_bio_num = 0;
	nsbi->r_re_data_page_num = 0;
	nsbi->r_re_node_bio_num = 0;
	nsbi->r_re_node_page_num = 0;
	nsbi->r_data_bio_num = 0;
	nsbi->r_data_page_num = 0;
	nsbi->r_node_bio_num = 0;
	nsbi->r_node_page_num = 0;

	nsbi->w_re_data_bio_num = 0;
	nsbi->w_re_data_page_num = 0;
	nsbi->w_re_node_bio_num = 0;
	nsbi->w_re_node_page_num = 0;
	nsbi->w_data_bio_num = 0;
	nsbi->w_data_page_num = 0;
	nsbi->w_node_bio_num = 0;
	nsbi->w_node_page_num = 0;

	nsbi->r_re_meta_bio_num = 0;
	nsbi->r_re_meta_page_num = 0;
	nsbi->w_re_meta_bio_num = 0;
	nsbi->w_re_meta_page_num = 0;

    // 直接IO
    nsbi->r_re_page_num = 0;
    nsbi->r_not_re_page_num = 0;
    nsbi->w_re_page_num = 0;
    nsbi->w_not_re_page_num = 0;

    nsbi->r_re_bio_num = 0;
    nsbi->r_not_re_bio_num = 0;
    nsbi->w_re_bio_num = 0;
    nsbi->w_not_re_bio_num = 0;
	...
	nsbi->whole_seg_gc_num = 0;
	nsbi->block_gc_seg_num = 0;
	nsbi->block_gc_num = 0;
	/*end*/
	return 0;
